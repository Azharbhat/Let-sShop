                ...
                <div className="collect__item__actions">
                    <div className="add__cart__add__wish">
                        <div className="add__cart">
                            <Button variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: '#61c9cd;', borderColor: '#61c9cd;', borderWidth: '3px', color: 'white'}, minWidth: 200, borderColor: '#61c9cd;', backgroundColor: "white" , color: "#61c9cd;", borderWidth: '3px'}]} onClick={handelAddToCart}>ADD TO BAG</Button>
                        </div>
                        <div className="add__wish">
                            <IconButton variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: '#61c9cd', borderColor: 'white;', borderWidth: '3px', color: 'white'}, borderColor: '#61c9cd;', backgroundColor: "white" , color: "#61c9cd", borderWidth: '3px'}]} onClick={handelAddToWish}>
